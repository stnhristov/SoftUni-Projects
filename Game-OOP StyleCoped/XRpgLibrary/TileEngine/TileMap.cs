...
namespace XRpgLibrary.TileEngine
{
    public class TileMap
    {
        ...
        public TileMap(List<Tileset> tilesets,List<MapLayer>layers)
        {
            ...
            {
                if (mapWidth != mapLayers[i].Width || mapHeight != mapLayers[i].Height) throw new Exception("Map layer size exception");
            }
        }
        ...
        {
            if (layer.Width != mapWidth && layer.Height != mapHeight) throw new Exception("Map layer size exception");
            mapLayers.Add(layer);
        }
